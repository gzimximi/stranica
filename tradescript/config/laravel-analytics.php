...
return
    ...
    [
         ...
         */
        'clientId' => '393609721978-1j2sm0g84fjneacpeusrcpqsrcf69jns.apps.googleusercontent.com', // secret KuXONrGUz5yDsel8-A41MwP4
         ...
         */
        'serviceEmail' => 'skins-ee@eighth-jigsaw-122821.iam.gserviceaccount.com',

        /*
         * You need to download a p12-certifciate from the Google API console
         * Be sure to store this file in a secure location.
         */
        'certificatePath' => storage_path('laravel-analytics/Skinsee-6216ae36e540.p12'),
